...
class CategoriesBlocEvent with _$CategoriesBlocEvent{
  ...
  const factory CategoriesBlocEvent.add({required String uuid, required CategoryExpenses data, required Completer<dynamic> completer,}) = _addEvent;
  const factory CategoriesBlocEvent.delete({required String uuid, required CategoryExpenses data,}) = _deleteEvent;
}
